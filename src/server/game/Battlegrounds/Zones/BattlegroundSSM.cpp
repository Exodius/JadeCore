...
void BattlegroundSSM::FillInitialWorldStates(WorldStateBuilder& builder)
{
    builder.AppendState(SSM_MINE_CARTS_DISPLAY, DISPLAY_WORLDSTATE);
	builder.AppendState(SSM_ALLIANCE_RESOURCES, GetTeamScore(ALLIANCE));
    builder.AppendState(SSM_HORDE_RESOURCES, GetTeamScore(HORDE));
    builder.AppendState(SSM_MINE_CART_1, DISPLAY_WORLDSTATE);
    builder.AppendState(SSM_MINE_CART_2, DISPLAY_WORLDSTATE);
    builder.AppendState(SSM_DISPLAY_ALLIANCE_RESSOURCES, DISPLAY_WORLDSTATE);
    builder.AppendState(SSM_MINE_CART_3, DISPLAY_WORLDSTATE);
    builder.AppendState(SSM_DISPLAY_HORDE_RESSOURCES, DISPLAY_WORLDSTATE);
    builder.AppendState(SSM_DISPLAY_PROGRESS_BAR, BG_SSM_PROGRESS_BAR_DONT_SHOW);  // This shows the mine cart control bar
    builder.AppendState(SSM_PROGRESS_BAR_STATUS, BG_SSM_PROGRESS_BAR_NEUTRAL);  // Neutral
    builder.AppendState(SSM_UNK, 0);
}
